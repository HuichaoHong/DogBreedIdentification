...
class myAugmentation(object):
	...
	def __init__(self, train_path="../data/train_data", label_path="../data/train_labels", merge_path="../data/merge", aug_merge_path="../data/aug_merge", aug_train_path="../data/aug_train", aug_label_path="../data/aug_label", img_type="jpg"):
	...
	def doAugmentate(self, img, save_to_dir, save_prefix, batch_size=1, save_format='jpg', imgnum=30):
...
class dataProcess(object):
	...
	def __init__(self, out_rows, out_cols, data_path = "../data/train_data", label_path = "../data/train_labels", test_path = "../data/test", npy_path = "../data/npydata", img_type = "jpg"):
